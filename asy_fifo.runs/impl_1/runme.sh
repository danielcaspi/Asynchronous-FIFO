...
HD_PWD='C:/Users/dqnie/Desktop/v_p/asy_fifo/asy_fifo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log asy_fifo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source asy_fifo.tcl -notrace
