...
HD_PWD='C:/Users/dqnie/Desktop/v_p/asy_fifo/asy_fifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asy_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asy_fifo.tcl
